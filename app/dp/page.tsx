      ...
      sections={[
        {
          ...
          body: "Inside the app, the profile picture (the DP) shows as a tiny circle — about 150 pixels on most phones. The actual file Instagram stores is much larger. This page pulls the full-size version and gives it to you as a JPG.\n\nFor most accounts the avatar lands at 320×320 to 640×640, depending on what the owner uploaded. That's the maximum Instagram serves publicly. It's not 1080×1080 (that's reserved for posts), but it is the largest size available without logging into the owner's account, which no honest tool can do.\n\nThe insta profile viewer flow on this page works the same regardless of whether you follow the account. Public, private, business, personal — the avatar is fetched the same way because Instagram exposes it on every profile by design.",
        },
        {
